...
import { Search, Trash2, Plus, ExternalLink, Briefcase } from "lucide-react";
        ...
        <div className="flex flex-col h-full">
          <div className="flex flex-1">
            ...
            <div className="w-1/3 border-r border-gray-700 flex flex-col">
              ...
              <Tabs value={activeInputTab} onValueChange={(value) => setActiveInputTab(value as "schema" | "json")} className="flex-1 flex flex-col">
          ...
          <div className="grid gap-2">
            ...
            <div className="w-1/3 flex flex-col">
              ...
              <div className="flex-1 flex items-center justify-center">
                <p className="text-gray-400 text-center">Execute this node to view data</p>
              </div>
          </div>
          </div>

          {/* Footer inside the dialog */}
          <div className="border-t border-gray-700 bg-gray-900 p-4 flex justify-end gap-2">
            <Button variant="outline" onClick={handleCancel} className="border-gray-600 text-white hover:bg-gray-800">
              Cancel
            </Button>
